...
const LikeSection = (props) => {
  ...
  // console.log("likes state through props in LikeSection compoenent: ", props);

  console.log("likePost: ", props.likePost);
  ...
  return (
    <div>
      ...
      <p className="like-number" onClick={props.likePost}>
        {props.likes}
      </p>
    </div>
  );
